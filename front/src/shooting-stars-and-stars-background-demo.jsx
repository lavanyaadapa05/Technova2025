    ...
    <div className="relative min-h-screen bg-gradient-to-b from-gray-900 to-black overflow-hidden">
      ...
      <div className="relative flex flex-col items-center justify-center h-screen text-center">
        ...
        <img 
          src="/logo.png" 
          alt="Logo"
          className="w-25 h-25 mb-6 drop-shadow-[0_0_15px_rgba(255,255,255,0.5)] animate-pulse" // Adjust width & height
        />
...
>
  ...
  <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-3 px-14 ring-1 ring-white/10">
